...
export const nsstaCourses: NSSTACourse[] = [
  ...
  },
  {
    ...
    provider: 'NSSTA',
    description:
      'Revision of basic sampling techniques, small area estimation, sampling for rare populations, network sampling, quota sampling, cluster sampling — using live NSSO and health survey examples.',
  },
  {
    ...
    provider: 'NSSTA',
    description:
      'Survey planning, frame and sample selection, questionnaire design, field/computer scrutiny, estimation procedures, multipliers, and report writing — practical grounding via NSSO, NFHS, RCH, SRS surveys.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Core Python for data science: NumPy, Pandas, Matplotlib, Seaborn, SciPy, statsmodels, scikit-learn — from language basics through data pre-processing and model building.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Communicating statistical findings to non-technical audiences — framing, narrative structure, and visual storytelling for official statistics.',
  },
  {
